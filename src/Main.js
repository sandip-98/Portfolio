                            ...
                            <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12'>
                                <div className='left-section'>
                                    ...
                                    <div className='buttons'>
                                        <a href="sandip-resume.pdf" download="sandip-cv">
                                            <button className='btn' href>Download Resume</button>
                                        </a>
                                        <a href='https://github.com/sandip-98'>
                            ...
                            <div className='container'>
                                <div className='row'>
                                    <div className='col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 '>
                                        <div className='card-body zzz'>
                                            <img src='images/choco.png' alt='' />
                                            <div className='card-text'>
                                                <h5>Choco</h5>
                                                <p>Html, Css, Bootstrap, Javascript, Jquery, Reactjs, Redux</p>
                                                <a href="https://choco-topaz.vercel.app/" className='btn-pro'>Visit</a>
                                                <a href="https://github.com/sandip-98/choco.git" className='btn-pro'>Code</a>
                                            </div>
                                        </div>
                                    </div>
